...
if ! { [[ "${script_name}" == "secure_check" ]] || [[ "${script_name}" == "move_ingest2ceph" ]] || [[ "${script_name}" == "upload_checksum_file" ]] || [[ "${script_name}" == "rename" ]] || [[ "${script_name}" == "notification_before" ]] || [[ "${script_name}" == "run_architekt" ]] || [[ "${script_name}" == "derivate_generation_2" ]]; }; then
