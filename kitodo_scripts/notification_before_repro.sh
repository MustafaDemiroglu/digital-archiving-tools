...
SUBJECT="Repro Projekt: Nacharbeitung erforderlich – ${kitodo_processtitle} in Lieferung ${meta_delivery}"

# 4. Build mail body
MAIL_BODY=$(cat <<EOF
Liebe Kolleginnen und Kollegen,

im Rahmen eines Repro Projektes wurde in der Lieferung ${meta_delivery} ein Vorgang festgestellt,
